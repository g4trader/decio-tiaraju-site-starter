...
export function SiteHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-white/10 bg-gradient-to-r from-[#020817]/95 via-[#07224a]/92 to-[#020817]/95 backdrop-blur">
      ...
      {open && (
        <div
          ...
          className="md:hidden"
        >
          <div className="border-t border-white/10 bg-gradient-to-br from-[#020817]/98 via-[#07224a]/95 to-[#020817]/98 px-4 pb-6 pt-4 shadow-2xl shadow-black/40">
